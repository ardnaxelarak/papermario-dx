...
EvtScript N(EVS_NpcInit_LilOink) = {
    Call(EnableNpcShadow, NPC_SELF, false)
    Call(SetNpcFlagBits, NPC_SELF, NPC_FLAG_INVISIBLE, true)
...
NpcData N(NpcData_LilOinks)[] = {
    {
        ...
        .init = &N(EVS_NpcInit_LilOink),
        .settings = &N(NpcSettings_Toad_Wander),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_ENABLE_HIT_SCRIPT | ENEMY_FLAG_IGNORE_WORLD_COLLISION | ENEMY_FLAG_IGNORE_ENTITY_COLLISION | ENEMY_FLAG_FLYING | ENEMY_FLAG_NO_SHADOW_RAYCAST | ENEMY_FLAG_DO_NOT_AUTO_FACE_PLAYER,
        .drops = NO_DROPS,
        .animations = TOAD_BLUE_ANIMS,
    },
    {
